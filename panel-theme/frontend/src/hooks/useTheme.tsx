...
// Netch / NovaNetchX brand accent. Applied to every page via ConfigProvider so
// buttons, inputs, focus rings, links and active states pick it up instead of
// antd's default blue. Teal #289DB7 from the brand logo.
const NETCH_ACCENT = '#289DB7';
const BRAND_TOKENS = {
  colorPrimary: NETCH_ACCENT,
  colorInfo: NETCH_ACCENT,
  colorLink: NETCH_ACCENT,
  colorLinkHover: '#3FC9E6',
};
...
export function buildAntdThemeConfig(isDark: boolean, isUltra: boolean): ThemeConfig {
  ...
  return {
    ...
    token: { ...(isUltra ? ULTRA_DARK_TOKENS : DARK_TOKENS), ...BRAND_TOKENS },
    components: {

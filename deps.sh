...
SETUP_NGINX() {
    ...
    # NOTE: ngx_stream_geoip2_module is intentionally NOT loaded — nothing in
    # this config uses geoip2, and libnginx-mod-stream-geoip2 isn't installed
    # by install_deps(), so loading it here just breaks `nginx -t`.
